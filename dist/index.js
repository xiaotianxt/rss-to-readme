 ...
 */
async function run() {
    const core = await __nccwpck_require__.e(/* import() */ 921).then(__nccwpck_require__.bind(__nccwpck_require__, 3921));
    try {
        ...
        const { Octokit } = await __nccwpck_require__.e(/* import() */ 570).then(__nccwpck_require__.bind(__nccwpck_require__, 8570));
        ...
        const newContent = content.replace(/<!-- start: feed -->[\s\S]*<!-- end: feed -->/, `<!-- start: feed -->\n${lines}\n<!-- end: feed -->`);
